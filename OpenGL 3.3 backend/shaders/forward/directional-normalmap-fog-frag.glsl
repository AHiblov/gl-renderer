...
void main()
{
	...
	vec4 resultColour = textureAmbientColour * vec4(ambientLightColour, 1.0) + textureDiffuseColour * clamp(dot(textureNormalTang.xyz, -passLightDirectionTang), 0.0, 1.0) * vec4(diffuseLightColour, 1.0);
